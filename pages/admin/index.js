...
import { Users, Calendar, Trophy, TrendingUp, Plus, FileDown, Upload, Calculator, Shield, Settings } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      ...
      <Modal
        ...
        size="lg"
      >
        <AdminManagementForm onClose={() => setShowAdminModal(false)} />
      </Modal>
...
// New Admin Management Component
function AdminManagementForm({ onClose }) {
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          <h4 className="text-lg font-semibold">Current Administrators</h4>
          <button
      ...
      {showAddForm && (
        <div className="border-t pt-6">
          <h4 className="text-lg font-semibold mb-4">Add New Administrator</h4>
